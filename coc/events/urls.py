...
urlpatterns = [
    ...
    path('event_list/', views.events_list, name='events_list'),
    ...
    path('stream_details/<int:stream_id>/register/', views.event_detail, name='stream_event_detail'),
    ...
    path('church_event_detail/<int:pk>/', views.event_detail, name='event_detail'),
