...
#    path('subscribe/', views.SubChannelSubscriptionView.as_view, name='subscribe'),
    ...
    path('sermons/<int:video_id>/', views.sermon_detail, name='sermon_detail'),
...
#    path('search/', views.search_videos, name='video_search'),
    ...
    path('plot/', views.simple_plot, name='simple_plot'),
    ...
    path('playlists/<slug:slug>/delete/', views.delete_playlist, name='delete_playlist'),
    path('playlists/<slug:slug>/add/<int:video_id>/', views.add_to_playlist, name='add_to_playlist'),
    path('playlists/<slug:slug>/remove/<int:video_id>/', views.remove_video_from_playlist, name='remove_from_playlist'),
    path('playlists/<slug:slug>/reorder/', views.reorder_playlist, name='reorder_playlist'),
    path('watched-videos/', views.watched_videos, name='watched_videos'),
    path('videos/<int:video_id>/mark-watched/', views.mark_video_watched, name='mark_video_watched'),
    path('queue/', views.queue_view, name='queue'),
    path('queue/add/<int:video_id>/', views.add_to_queue, name='add_to_queue'),
    path('queue/remove/<int:video_id>/', views.remove_from_queue, name='remove_from_queue'),
    path('queue/reorder/', views.reorder_queue, name='reorder_queue'),
    path('offline-videos/', views.offline_videos, name='offline_videos'),
    path('offline-videos/<int:video_id>/play/', views.play_offline_video, name='play_offline_video'),
